'''
Floodlight SDN controller Phantom App constants
...
@date April 27, 2016
'''
FLOODLIGHTAPP_CONTROLLER_URL = "url"

FLOODLIGHTAPP_ERR_SERVER_CONNECTION = "Connection to controller failed"

FLOODLIGHTAPP_ERR_CONNECTIVITY_TEST = "Connectivity test failed"
FLOODLIGHTAPP_SUCC_CONNECTIVITY_TEST = "Connectivity test passed"

FLOODLIGHTAPP_SUCC = "Action succeeded."
FLOODLIGHTAPP_ERR_NO_STATUS = "Action returned no status code"
FLOODLIGHTAPP_ERR_NO_DATA = "Action returned no data"
FLOODLIGHTAPP_ERR_PARSE = "Unparseable data returned from REST API"
FLOODLIGHTAPP_ERR_PARAM = "Invalid parameter"
